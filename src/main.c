...
static void print_usage(const char *prog) {
	fprintf(stderr,
		...
		"  ]}\n\n"
		"Commands JSON (single object or array of objects):\n"
		"  {\"cmd\": \"text\", \"id\": 0, \"x\": 100, \"y\": 200, \"text\": \"Hello\"}\n"
		"  [{\"cmd\": \"clear\"}, {\"cmd\": \"image\", \"path\": \"splash.png\"}]\n\n"
		"Available commands:\n"
		"  clear, bg_color, image, text, remove_text, rect, remove_rect,\n"
		"  overlay, remove_overlay, progress, update_progress, hide_progress,\n"
		"  animate, spinner, suspend, resume, status, ready, exit\n\n"
		"Examples:\n"
		"  %s /dev/dri/card0\n"
		"  %s /dev/dri/card0 --config '{\"fonts\":[{\"slot\":0,\"path\":\"font.ttf\",\"size\":24}]}'\n"
		"  %s /dev/dri/card0 --config /etc/splash.json --cmds /etc/splash-boot.json\n",
